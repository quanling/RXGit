...
#import "QLNetworkHelp.h"
#import "AFNetworking.h"
#import "MBProgressHUD+QL.h"
#define kWindow        [UIApplication sharedApplication].delegate.window

static NSString * const kAFNetworkingLockName = @"com.alamofire.networking.operation.lock";

@interface QLNetworkHelp ()
 ...
 */
+ (id)shareInstance{
    static QLNetworkHelp *helper;
    static dispatch_once_t onceToken;
    
    __weak QLNetworkHelp *weakSelf = helper;
    dispatch_once(&onceToken, ^{
        if (helper == nil) {
            helper = [[QLNetworkHelp alloc]init];
...
- (void)GET:(NSString *)url Parameters:(NSDictionary *)parameters Success:(void (^)(id))success Failure:(void (^)(NSError *))failure{
    ...
    //网络检查
    [QLNetworkHelp checkingNetworkResult:^(NetworkStatus status) {
